// Modified from: https://github.com/pmndrs/drei/blob/master/src/core/Stars.tsx
...
export const StarsV2: ForwardRefComponent<StarsProps, Points> = /* @__PURE__ */ React.forwardRef(
  ({ radius = 100, depth = 50, count = 5000, saturation = 0, factor = 4, fade = false, twinkling = false, speed = 1 }, ref) => {
    ...
    useFrame((state) => material.current && twinkling && (material.current.uniforms.time!.value = state.clock.elapsedTime * speed))
